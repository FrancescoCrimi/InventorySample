...
{
    public sealed partial class ValidateConnectionDialog : ContentDialog
    {
        private string _connectionString = null;

        public ValidateConnectionDialog(string connectionString)
        {
            _connectionString = connectionString;
            ViewModel = Ioc.Default.GetService<ValidateConnectionViewModel>();
            InitializeComponent();
            Loaded += OnLoaded;
        }

...
namespace Inventory.Uwp.Views.Orders
{
    public sealed partial class OrdersView : Page
    {
        ...
        private async void OpenInNewView(object sender, RoutedEventArgs e)
        {
            ...
            await windowService.OpenWindow(typeof(OrdersView), args);
        }
        ...
        private async void OpenDetailsInNewView(object sender, RoutedEventArgs e)
        {
            ...
            {
                await windowService.OpenWindow(typeof(OrderView), ViewModel.OrderDetails.CreateArgs());
            }
            else
            {
                await windowService.OpenWindow(typeof(OrderItemsView), ViewModel.OrderItemList.CreateArgs());
            }
        }

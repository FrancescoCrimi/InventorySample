...
namespace Inventory.Uwp.Views.Customers
{
    public sealed partial class CustomersView : Page
    {
        ...
        private async void OpenInNewView(object sender, RoutedEventArgs e)
        {
            ...
            await windowService.OpenWindow(typeof(CustomersView), args);
        }
        ...
        private async void OpenDetailsInNewView(object sender, RoutedEventArgs e)
        {
            ...
            {
                await windowService.OpenWindow(typeof(CustomerView), ViewModel.CustomerDetails.CreateArgs());
            }
            else
            {
                await windowService.OpenWindow(typeof(CustomerView), ViewModel.CustomerOrders.CreateArgs());
            }
        }

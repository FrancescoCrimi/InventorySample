...
namespace Inventory.Uwp.Helpers
{
    ...
    public static class SettingsStorageExtensions
    {
        ...
        public static void SaveBoolean(this ApplicationDataContainer settings, string key, bool value)
        ...
        public static bool ReadBoolean(this ApplicationDataContainer settings, string key, bool? defaultValue = null)
        {
            if (defaultValue != null)
                if (!settings.Values.ContainsKey(key))
                    settings.Values[key] = defaultValue;
            return (bool)settings.Values[key];
        }

        public static int ReadInt(this ApplicationDataContainer settings, string key, int? defaultValue = null)
        {
            if (defaultValue != null)
                if (!settings.Values.ContainsKey(key))
                    settings.Values[key] = defaultValue;
        ...
        public static string ReadString(this ApplicationDataContainer settings, string key, string defaultValue = null)
        {
            if (!settings.Values.ContainsKey(key))
                settings.Values[key] = defaultValue;
